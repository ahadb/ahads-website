                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="inline-block rounded-full border border-blue-200 bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700">
                        {caseStudy.industry}
                      </span>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-semibold text-green-600">
                        ✓ {caseStudy.businessImpact.split('.')[0]}.
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {caseStudy.technicalStack.slice(0, 3).map((tech) => (
                        <span
                          key={tech}
                          className="inline-block rounded-full border border-gray-200 bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-700"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="flex items-center">
                    <span className="flex items-center gap-1 text-sm font-semibold text-gray-800 transition-colors group-hover:text-gray-900">
                      View Case Study
