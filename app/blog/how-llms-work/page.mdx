...
**Goal:** Learn general language structure and facts. In pretraining, the model ingests massive datasets: books, websites, Wikipedia, open-source code, and more. It's trained on trillions of tokens using a technique called _causal language modeling_ — predicting the next token, one after another.
